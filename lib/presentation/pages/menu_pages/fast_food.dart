...
class FastFoodsPage extends StatefulWidget {
  const FastFoodsPage({Key? key}) : super(key: key);

  @override
  State<FastFoodsPage> createState() => _FastFoodsPageState();
}

class _FastFoodsPageState extends State<FastFoodsPage> {
          ...
          Expanded(
            child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return productCard(fastFoods()[index], index);
                }),
          )
        ],
      ),
  ...
  List<Product> fastFoods() {
    List<Product> fastFoodsList = [];
    for (var element in getProducts()) {
      if (element.type == "fastFoods") {
        fastFoodsList.add(element);
      }
    }
